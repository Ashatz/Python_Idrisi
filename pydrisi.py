...
try:
    ...
    print("Could not import win32com.client. Please ensure win32com.client is properly installed.")
    sys.exit()
...
#===============================================================================
# BEGIN NON IDRISI FUNCTIONS
#===============================================================================

def getdir(full_path):
    path_component = full_path.split("\\")
    path_component.pop()
    return "\\".join(path_component)
...
#===============================================================================
# END NON IDRISI FUNCTIONS
#===============================================================================

#===============================================================================
# BEGIN IDRISI FUNCTIONS
#===============================================================================

#Some of these just duplicate Idrisi API Functionality, but the goal is to prevent the need to
#  import the Idrisi API into the script.
def set_workspace(workspace):
    idrisi.SetWorkingDir(workspace)

#The only option so far is to reclass by .rcl file, because this is easier than doing it using
#  the idrisi macro commands for reclass thresholds (especially when there are many)
def reclass_by_rcl(in_raster, out_raster, rcl_file):
    idrisi.RunModule('reclass', r"I*%s*%s*3*%s*1"%(in_raster, out_raster, rcl_file),1,'','','','',1)

#The Idrisi extract module.
...
#Create an initial image by copying the extent of another image.
...
#This crosstab creates a hard classified cross classification.
